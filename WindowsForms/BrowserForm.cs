...
namespace WebView2WindowsFormsBrowser
{
    public partial class BrowserForm : Form
    {
        ...
        void AttachControlEventHandlers(Microsoft.Web.WebView2.WinForms.WebView2 control) {
            ...
            control.WebMessageReceived += webView2_WebMessageReceived;
        }
        ...
        {
            return "https://opportunitywatchlist.pilottrading.co";
        }
        ...
        private void webView2_WebMessageReceived(object sender, Microsoft.Web.WebView2.Core.CoreWebView2WebMessageReceivedEventArgs args)
        {
            ...
            string messagetext = args.TryGetWebMessageAsString();
